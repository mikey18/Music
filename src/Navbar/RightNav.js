...
const RightNav = () => {
    return (  
            <UL>
                <li><Link to="#"><img src = {facebook} width = "34" alt = "social"></img></Link></li>
                <li><Link to="#"><img src = {instagram} width = "35" alt = "social"></img></Link></li>
                <li><Link to="#"><img src = {twitter} width = "35" alt = "social"></img></Link></li>
