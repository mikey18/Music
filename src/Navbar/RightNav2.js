...
const RightNav2 = ({open}) => {
    return (  
            <UL open = {open}>
                <li><Link to="#"><h3>Facebook</h3><img src = {facebook} width = "34" alt = "social"></img></Link></li>
                <li><Link to="#"><h3>Instagram</h3><img src = {instagram} width = "35" alt = "social"></img></Link></li>
                <li><Link to="#"><h3>Twitter</h3><img src = {twitter} width = "35" alt = "social"></img></Link></li>
